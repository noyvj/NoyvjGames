...
def test_info_page_toggle_independent_of_coda(game_env):
    # The Info Page and the long-horizon coda are two separate panels --
    # opening one shouldn't touch the other's visibility.
    game_env.toggle_info_page()
