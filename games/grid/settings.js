/*
 * Grid — settings panel: text-scale + reduced-motion toggle.
 *
...
(function () {
  ...
  const TEXT_SCALE_KEY = "grid-text-scale";
  const MOTION_KEY = "grid-reduced-motion";
  ...
  window.GridSettings = { applyScale: applyScale, applyMotion: applyMotion, MIN_SCALE: MIN_SCALE, MAX_SCALE: MAX_SCALE };
})();
