...
class FakeProxy:
    ...
    unchanged, since a FakeProxy is still plainly callable."""
...
class FakeTimers:
    ...
    toast's auto-hide timer). Same shape as SOL's tests/fakes.py FakeTimers,
    minus setInterval -- Grid is turn-based, it has no interval-driven loop."""
