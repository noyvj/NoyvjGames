...
def test_changing_grid_size_updates_the_css_column_count(game_env):
    """B13 regression: style.css's `.plot-grid` rule hardcodes 6 columns,
    so render_grid() must set an inline gridTemplateColumns override or
