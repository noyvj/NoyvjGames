/*
 * SOL — settings panel: text-scale + reduced-motion toggle.
 *
...
(function () {
  ...
  const TEXT_SCALE_KEY = "sol-text-scale";
  const MOTION_KEY = "sol-reduced-motion";
  ...
  window.SolSettings = { applyScale: applyScale, applyMotion: applyMotion, MIN_SCALE: MIN_SCALE, MAX_SCALE: MAX_SCALE };
})();
