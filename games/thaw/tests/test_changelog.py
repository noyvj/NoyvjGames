...
the in-game toggle/panel. Same idiom as Herd/Aftermath's own test_changelog.py,
minus any earned/unearned state -- a changelog entry is just curated
highlight text, not a checkable condition.
"""
