/*
 * Tide — settings panel: text-scale + reduced-motion toggle.
 *
...
(function () {
  ...
  const TEXT_SCALE_KEY = "tide-text-scale";
  const MOTION_KEY = "tide-reduced-motion";
  ...
  window.TideSettings = { applyScale: applyScale, applyMotion: applyMotion, MIN_SCALE: MIN_SCALE, MAX_SCALE: MAX_SCALE };
})();
