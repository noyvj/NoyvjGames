/*
 * Aftermath — settings panel: text-scale + reduced-motion toggle.
 *
...
(function () {
  ...
  window.AftermathSettings = { applyScale: applyScale, applyMotion: applyMotion, MIN_SCALE: MIN_SCALE, MAX_SCALE: MAX_SCALE };
})();
