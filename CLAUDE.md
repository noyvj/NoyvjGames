...
| continuum | Continuum (working title) | Milestone 9 done (Classical era) — Phase 1 (Foundation) and Phase 2 (story/era-transition framework) complete; Phase 3 content expansion underway with Agrarian and Classical eras fully built (sim content, research tier, sustainability adjustment, log/transition beats, info-panel content each), Medieval/Industrial/Digital/Space Age still pending. Flagship BCM114 Round 2 DA (SDG 11). Not yet hub-linked |
