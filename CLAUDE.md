...
| continuum | Continuum (working title) | Milestone 13 done (Space Age era) — Phase 1 (Foundation), Phase 2 (story/era-transition framework), Phase 3 (content expansion) and Phase 4 (save/security audit) all complete: all seven eras (Tribal through Space Age) fully built, each with sim content, a research tier, a sustainability mechanic, log/transition beats and info-panel content — Industrial, Digital and Space Age each add a distinct mechanical consequence rather than a repeated score-side bonus/penalty shape (Industrial/Digital growth-side, Space Age a new fourth livability provision instead of a third growth lever). Phase 4's dedicated save/security audit found and fixed six real save-robustness bugs (an era-restoration crash reachable via revisit, adversarial numeric values, a NaN/Infinity gap, a growth-loop page-freeze, revisit era cross-contamination, and a log-restore crash); test count 372 → 384. Phase 5 (Three.js visuals) and Phase 6 (hub integration) remain. Flagship BCM114 Round 2 DA (SDG 11). Not yet hub-linked |
