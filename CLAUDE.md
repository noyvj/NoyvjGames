...
| continuum | Continuum (working title) | Milestone 10 done (Medieval era) — Phase 1 (Foundation) and Phase 2 (story/era-transition framework) complete; Phase 3 content expansion underway with Agrarian, Classical and Medieval eras fully built (sim content, research tier, sustainability adjustment, log/transition beats, info-panel content each), Industrial/Digital/Space Age still pending. Flagship BCM114 Round 2 DA (SDG 11). Not yet hub-linked |
