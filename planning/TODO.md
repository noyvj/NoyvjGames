...
- [ ] U13 **(decided 2026-09-26, ready to build)**: Hub: collapsible title cards, **compact by default** (picture, name, rating stars; click to expand for the text, review widget and feedback), remembering the choice on this device, with "Play"/clicking the picture or name still opening the game.
